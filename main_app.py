...
if uploaded_file is not None:
    ...
    genai.configure(api_key="AIzaSyDzg1YuwkBsU_whJvghcsnMVRliKtAZVSY")
    model = genai.GenerativeModel("gemini-1.5-flash")
    response = model.generate_content("Explain how AI works")


    os.environ["GOOGLE_API_KEY"] = "AIzaSyDzg1YuwkBsU_whJvghcsnMVRliKtAZVSY"
    if "GOOGLE_API_KEY" not in os.environ:
        os.environ["GOOGLE_API_KEY"] = getpass("AIzaSyDzg1YuwkBsU_whJvghcsnMVRliKtAZVSY")
